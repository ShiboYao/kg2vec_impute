...
class GCN(nn.Module):
    def __init__(self, nfeatures: int, hiddenunits: List[int], drop_prob: float, propagation: nn.Module, bias: bool = False):
        super().__init__()
        ...
        fcs.append(nn.Linear(hiddenunits[-1], nfeatures, bias=bias))
